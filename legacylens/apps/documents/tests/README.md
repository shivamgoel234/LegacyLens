...
This directory contains integration tests for the legacylens document processing functionality. These tests connect to actual Azure services to validate the real-world functionality of the system.

## Testing Philosophy

In legacylens, we prioritize real-world testing over mock-based testing. This approach ensures:
...
python manage.py test legacylens.apps.documents.tests.test_document_service
```
