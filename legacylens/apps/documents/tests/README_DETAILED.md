# legacylens Document Service Testing - Detailed Guide

This document provides detailed information for running the document service tests in legacylens. These tests connect to **actual Azure services** to validate the real-world functionality of the system.
...
./legacylens/apps/documents/tests/run_tests.sh
```
...
python manage.py test legacylens.apps.documents.tests.test_document_service.TestDocumentServiceIntegration.test_01_document_upload_and_processing
```
...
./legacylens/apps/documents/tests/run_tests.sh -v=2

# Run specific test
./legacylens/apps/documents/tests/run_tests.sh -t=test_01_document_upload_and_processing
```
...
Top result snippet: This is a test document for legacylens integration test 12345678...
