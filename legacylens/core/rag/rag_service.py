"""
RAG service implementation for legacylens.
...
from legacylens.core.azure_utils.clients import AzureClientManager
from legacylens.core.conversation.factory import ConversationManagerFactory
from legacylens.core.formatters.factory import FormatterFactory
from legacylens.core.generation.factory import ResponseGeneratorFactory
from legacylens.core.rag.context_service import ContextService
...
class RAGService:
    ...
    async def generate_response(
        ...
        from legacylens.core.rag.templates import RAGPromptManager
